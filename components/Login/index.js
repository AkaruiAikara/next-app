                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                        ...
                        <div className="text-center text-md font-medium text-gray-500 dark:text-gray-300">
                            Don't have an account? Click <Link href={router.pathname + '/?register=true'} as="/register"><button type="button" className="text-blood hover:underline dark:text-red-800">Here</button></Link>
                        </div>
                    </form>
                </div>
            </div>
